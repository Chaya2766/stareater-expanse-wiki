...
\begin{document}
	...
	\begin{itemize}
		...
		\item Made from hardened 304 stainless steel (tensile strength 1050MPa and density 7900$kg/m^3$)
	...
	$$ R_c = \frac{1050MPa}{2 \cdot 7900kg/m^3 \cdot (9.807m/s^2 + \frac{101325 Pa}{10 000kg/m^2})} = 3332.925235m$$
	
	As such this example habitat is nearly 3.333km in radius.
