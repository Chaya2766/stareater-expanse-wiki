...
\begin{document}
	...
	\begin{abstract}
		...
		The approximate energy required to separate a kilogram of matter composed in equal parts by weight of the first 104 elements of the periodic table into the individual elements via this process is between 6.4685GJ and 64.685GJ.
	\end{abstract}
    ...
    Correspondingly the specific energy of refining general matter would be approximately between 6.4685 GJ/kg and 64.685 GJ/kg.
