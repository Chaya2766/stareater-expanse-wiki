...
\begin{document}
    ...
    \begin{itemize}
    	\item Efficiency of the ion source:
    	
    	The best method for generating ions seems to be \href{https://en.wikipedia.org/wiki/Electron_ionization#The_efficiency_of_EI}{Electron Ionization} achieved by bombarding the material sample with electrons.
    	Judging from the following sentence given on wikipedia, I will set the efficiency at 0.1\%.
    	"Under these conditions, about 1 in 1000 analyte molecules in the source are ionized."
    ...
    $$ \epsilon = \frac{32.3424893575117 MJ/kg}{0.00025} = 129.3699574 GJ/kg $$
    
    For meteor material the energy per kilogram to be refined this way is approximately 310.13GJ/kg.
    
    $$ \epsilon = \frac{77.5334091946941 MJ/kg}{0.00025} = 310.1336368 GJ/kg $$
    
    For electrolytic kamacite the energy per kilogram to be refined this way is 54.358GJ/kg.
    
    $$ \epsilon = \frac{13.589417469546 MJ/kg}{0.00025} = 54.35766988 GJ/kg $$
