...
print(f"lost half of air pressure in {time_passed} seconds")
    ...
    (WARNING: valid only for full atmospheric pressure)
	...
	The armstrong limit (ie, pressure low enough that the boiling points of bodily fluids drops below typical human body temperature) is marked as a horizontal red line.
	...
	\begin{center}
		Graphed with X axis as distance from the hole in centimetres and Y axis as velocity in metres per second:
