...
\begin{document}
	...
	\begin{abstract}
		...
		The final findings were that the machine included in the Felicity tech tree, which is used for this process, would require 348MJ of energy and 22.38h of time to process one 100-kilogram batch of asteroid regolith into mixed metal alloy.
		The energy cost of the alloy was found to be 183.258 kJ/kg, and a single machine allows for production rate of 4.7146558 kg/h.
	\end{abstract}
	...
	This takes about 5 hours to complete.
	...
	\begin{itemize}
		...
		\item 5 hour time to completion - that is how long a successful sample took to process in the study.
    ...
    $$ \frac{347.9574564 MJ}{4134W} = 84169.67983 s \approx 22h + 22min + 50s
    %\qquad \frac{347.9574564 MJ}{4000W} = 86989.3641 s \approx 1 d + 10 min
    $$
    
    So the time required to proces a 100kg batch of regolith is \textbf{22.38h} or \textbf{80.57ks} of time.
