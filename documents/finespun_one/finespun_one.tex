...
\title{Finespun One habitat design calculations}
...
\begin{document}
    ...
    \begin{itemize}
    	...
    	\item $a$ is the shorter edge of the plate \footnote{I feel the need to justify why I say the parameter a refers to the shorter edge of the plate rather than the longer edge. Two reasons for me making that interpretation. On page 120 the table gives alpha values for b/a ratios of 1, 1.1, etc, up to 5 and then infinity, which suggests that b is larger than a. The other reason is the claim on bottom of page 118 that "as the ratio of b/a increases, the maximum deflection and the maximum moment of the plate rapidly approach the values calculated for a uniformly loaded strip".}
