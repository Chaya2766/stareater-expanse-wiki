...
\begin{document}
	...
	Copper has a 1st ionization energy of 745.5kJ/mol, that is, 745.5kJ needed to ionize 6.02214076E+23 atoms, which means ionizing the single copper atom required about 1.237766E-18 joules or 7.72553 electronvolts.
	
	\medskip
	
	It also has an enthalpy of vaporization of 300.3kJ/mol, which is 4.985599E-19 joules or 3.11239 electronvolts per atom. 
	...
	I will arbitrarily assume "a few" would mean 10.
	...
	$$ 7.72553eV + 3.11239eV + 10eV = 20.83792 eV $$
	
	\medskip
	
	In total, the atom absorbed nearly 21 electronvolts, but various inefficiencies might have created a discrepancy between the energy delivered to the atoms and energy consumed by the machine.
	...
	Ion beams usually have very low power, but it is forseeable that a machine made to print objects with them might incorporate multiple, so it is not facing much constraint on that end.
