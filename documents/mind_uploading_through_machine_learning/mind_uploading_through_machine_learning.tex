...
\begin{document}
	...
	Just for visualization sake, such a mimic neuron with 100 input streams, 205 miliseconds of history in each input stream, and a main body consisting of 5 layers each having 128 neurons, would look like this:
	...
	\section{Main problem with this model}
