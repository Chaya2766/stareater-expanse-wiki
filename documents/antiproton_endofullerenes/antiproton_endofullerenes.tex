...
\begin{document}
	...
	\begin{abstract}
		Investigation of antimatter storage using buckmeisterfullerenes (A.K.A. C60 or Buckyballs) for use in the Stareater Expanse worldbuilding project.
	...
	The evidence for and against the possibility of long term storage of antiprotons inside buckmeisterfullerenes is discussed in much greater detail in the following paper:
	...
	\begin{itemize}
		\item Some models of the buckmeisterfullerene show that a point charge placed in the middle of the molecule would experience no net force, and as such would not be held in the middle.
		...
		\item No observation of an antiproton placed inside a buckmeisterfullerene had been made so far, as such given the mixed theoretical evidence and total lack of practical evidence, the viability of antiproton endofullerenes cannot be accepted nor discarded.
	\end{itemize}
