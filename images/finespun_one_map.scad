...
color("#888"){square([2*pi*25,40],true);}
color("#FFF"){
translate([90,-0+5]){
...
for(i=[0:1:7]){
translate([(i-3.5)*((2*pi*40/8)+10),-50,0]){
    color("#888"){square([2*pi*40/8,40],true);}
    color("#FFF"){text(str(i+1),halign="center",valign="center");}
}}
color("#FFF"){
translate([170,-50+2.5]){
...
for(i=[0:1:7]){
translate([(i-3.5)*((2*pi*55/8)+10),-50*2,0]){
    color("#888"){square([2*pi*55/8,40],true);}
    color("#FFF"){text(str(i+9),halign="center",valign="center");}
}}
color("#FFF"){
translate([220,-100+2.5]){
...
for(i=[0:1:7]){
translate([(i-3.5)*((2*pi*70/8)+10),-50*3,0]){
    color("#888"){square([2*pi*70/8,40],true);}
    color("#FFF"){text(str(i+17),halign="center",valign="center");}
}}
color("#FFF"){
translate([270,-150+2.5]){
    text("level 3",size=10);
    translate([0,-10]){text("gravity: 5.6m/s²",size=5);}
}
}

// openscad finespun_one_map.scad -o finespun_one_map.png --colorscheme=Starnight --projection=o --imgsize=3000,1000