...
difference(){
    color(color_metal){cube([800,800,900]);}
    translate([100,100,100]){color(color_carbon){cube([600,600,900]);}}
    //translate([90,90,600]){color(color_plastic){cube([620,620,900]);}}
}
//sodium hydroxide bath
translate([100,100,100]){color(color_hydroxide){cube([600,600,560]);}}
//crane
color(color_metal){
    difference(){
        translate([350,800,0]){cube([100,175,600]);}
...
translate([0,0,1570]){
    color(color_metal){cube([800,800,200]);}
    translate([-10,-10,-10]){color(color_plastic){cube([820,820,10]);}}
    translate([400,400,-600]){color(color_carbon){cylinder(h=600,r=15);}}//this is the pole
    translate([400,400,0]){rotate([180,0,0]){recursive_tree();}}
